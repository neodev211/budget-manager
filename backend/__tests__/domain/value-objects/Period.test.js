...
describe('Period Value Object', () => {
    describe('Constructor', () => {
        it('should create period with valid YYYY-MM format', () => {
            const period = new Period_1.Period('2025-01');
            expect(period.value).toBe('2025-01');
        });
        it('should create period with valid format for different months', () => {
            const january = new Period_1.Period('2025-01');
            const december = new Period_1.Period('2025-12');
            expect(january.value).toBe('2025-01');
            expect(december.value).toBe('2025-12');
        });
        it('should throw on invalid format - single digit month', () => {
            expect(() => new Period_1.Period('2025-1')).toThrow('Invalid period format');
        });
        it('should throw on invalid format - single digit year', () => {
            expect(() => new Period_1.Period('25-01')).toThrow('Invalid period format');
        });
        it('should throw on invalid format - invalid separator', () => {
            expect(() => new Period_1.Period('2025/01')).toThrow('Invalid period format');
        });
        it('should throw on completely invalid format', () => {
            expect(() => new Period_1.Period('invalid')).toThrow('Invalid period format');
        });
        it('should throw on empty string', () => {
            expect(() => new Period_1.Period('')).toThrow('Invalid period format');
        });
        it('should throw on null-like string', () => {
            expect(() => new Period_1.Period('null')).toThrow('Invalid period format');
        });
    });
    describe('Static Validation', () => {
        it('should validate correct format', () => {
            expect(Period_1.Period.isValid('2025-01')).toBe(true);
            expect(Period_1.Period.isValid('2000-12')).toBe(true);
            expect(Period_1.Period.isValid('1999-01')).toBe(true);
        });
        it('should invalidate incorrect formats', () => {
            expect(Period_1.Period.isValid('2025-1')).toBe(false);
            expect(Period_1.Period.isValid('25-01')).toBe(false);
            expect(Period_1.Period.isValid('2025/01')).toBe(false);
            expect(Period_1.Period.isValid('invalid')).toBe(false);
            expect(Period_1.Period.isValid('')).toBe(false);
        });
    });
    describe('Factory Methods', () => {
        it('should create current period with now()', () => {
            const now = Period_1.Period.now();
        ...
        it('should create period from specific date', () => {
            ...
            const period = Period_1.Period.fromDate(date);
    ...
    describe('Extractors', () => {
        it('should extract year correctly', () => {
            const period = new Period_1.Period('2025-06');
    ...
    describe('Navigation - Previous', () => {
        ...
        it('should handle multiple iterations', () => {
            const period = new Period_1.Period('2025-03');
    ...
    describe('Navigation - Next', () => {
        ...
        it('should get next period crossing year boundary', () => {
            const period = new Period_1.Period('2025-12');
            const next = period.next();
            expect(next.value).toBe('2026-01');
        });
        it('should handle multiple iterations', () => {
            const period = new Period_1.Period('2025-11');
    ...
    describe('Navigation - Range', () => {
        it('should generate range of periods', () => {
            const start = new Period_1.Period('2025-01');
            const end = new Period_1.Period('2025-03');
            const range = Period_1.Period.range(start, end);
        ...
        it('should generate range for single period', () => {
            const period = new Period_1.Period('2025-01');
            const range = Period_1.Period.range(period, period);
            expect(range).toHaveLength(1);
            expect(range[0].value).toBe('2025-01');
        });
        it('should generate range crossing year boundary', () => {
            const start = new Period_1.Period('2024-11');
            const end = new Period_1.Period('2025-02');
            const range = Period_1.Period.range(start, end);
        ...
        it('should generate large range', () => {
            const start = new Period_1.Period('2025-01');
            const end = new Period_1.Period('2025-12');
            const range = Period_1.Period.range(start, end);
    ...
    describe('Comparison Methods', () => {
        const p1 = new Period_1.Period('2025-02');
        const p2 = new Period_1.Period('2025-01');
        const p3 = new Period_1.Period('2025-02');
        ...
        it('should handle year boundary comparisons', () => {
            const dec2024 = new Period_1.Period('2024-12');
            const jan2025 = new Period_1.Period('2025-01');
    ...
    describe('Temporal Checks', () => {
        ...
        it('should identify past period', () => {
            const pastPeriod = new Period_1.Period('2020-01');
        ...
        it('should identify future period', () => {
            const futurePeriod = new Period_1.Period('2030-12');
    ...
    describe('Chaining Navigation', () => {
        ...
        it('should handle complex chaining with range', () => {
            const start = new Period_1.Period('2025-01');
            const range = Period_1.Period.range(start, start.next().next());
            expect(range).toHaveLength(3);
            expect(range[0].value).toBe('2025-01');
            expect(range[2].value).toBe('2025-03');
        });
