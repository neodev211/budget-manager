...
describe('Money Value Object', () => {
    describe('Constructor', () => {
        ...
        it('should create money from string', () => {
            const money = new Money_1.Money('100.50');
            expect(money.value).toBe(100.5);
        });
        it('should create money from decimal string', () => {
            const money = new Money_1.Money('50.99');
            expect(money.value).toBe(50.99);
        });
        it('should round to 2 decimals automatically', () => {
            const money = new Money_1.Money(100.555);
            expect(money.value).toBe(100.56);
        });
        it('should round down correctly', () => {
            const money = new Money_1.Money(100.554);
            expect(money.value).toBe(100.55);
        });
        it('should throw on invalid string input', () => {
            expect(() => new Money_1.Money('invalid')).toThrow('Invalid money amount: must be a valid number');
        });
        it('should throw on NaN', () => {
            expect(() => new Money_1.Money(NaN)).toThrow('Invalid money amount: must be a valid number');
        });
        it('should handle zero correctly', () => {
            const money = new Money_1.Money(0);
            expect(money.value).toBe(0);
        });
        it('should handle negative numbers', () => {
            const money = new Money_1.Money(-50.25);
    ...
    describe('Factory Methods', () => {
        ...
        it('should create money from Prisma Decimal object', () => {
            ...
            const money = Money_1.Money.fromDecimal(prismaMockDecimal);
            expect(money.value).toBe(100.5);
        });
        it('should create money from plain number when Decimal lacks toNumber', () => {
            const money = Money_1.Money.fromDecimal(75.25);
            expect(money.value).toBe(75.25);
        });
        it('should handle null/undefined in fromDecimal', () => {
            const moneyFromNull = Money_1.Money.fromDecimal(null);
            expect(moneyFromNull.value).toBe(0);
            const moneyFromUndefined = Money_1.Money.fromDecimal(undefined);
    ...
    describe('Validation Methods', () => {
        ...
        it('should identify negative money', () => {
            const money = new Money_1.Money(-50);
    ...
    describe('Arithmetic Operations', () => {
        it('should add money correctly', () => {
            const a = new Money_1.Money(100);
            const b = new Money_1.Money(50);
            const result = a.add(b);
            expect(result.value).toBe(150);
        });
        it('should add with decimal precision', () => {
            const a = new Money_1.Money(100.50);
            const b = new Money_1.Money(50.25);
            const result = a.add(b);
            expect(result.value).toBe(150.75);
        });
        it('should subtract money correctly', () => {
            const a = new Money_1.Money(100);
            const b = new Money_1.Money(30);
            const result = a.subtract(b);
            expect(result.value).toBe(70);
        });
        it('should subtract with decimal precision', () => {
            const a = new Money_1.Money(100.75);
            const b = new Money_1.Money(25.50);
            const result = a.subtract(b);
        ...
        it('should multiply with decimal precision', () => {
            const money = new Money_1.Money(33.33);
    ...
    describe('Conversion Methods', () => {
        it('should convert to string with 2 decimals', () => {
            const money = new Money_1.Money(100.1);
        ...
        it('should handle edge case decimals in toString', () => {
            const money = new Money_1.Money(0.01);
    ...
    describe('Chaining Operations', () => {
        it('should support operation chaining', () => {
            const money = new Money_1.Money(100)
                .add(new Money_1.Money(50))
                .subtract(new Money_1.Money(25))
                .multiply(2);
